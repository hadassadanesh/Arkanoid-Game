...
/**
 * this class is in charge of printing the method "You Win! Your score is X".
...
public class YouWinAnimation implements Animation {
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        // draw "You Win! Your score is X".
        d.drawText(X_VALUE_OF_TEXT, yOfText, "You Win! Your score is " + getScore().getValue(),
                SIZE_OF_LETTERS);
    }
